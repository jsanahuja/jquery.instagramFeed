...
"<p class='instagram_private'><strong>This profile is private</strong></p>";else{var imgs=data.edge_owner_to_timeline_media.edges;max=imgs.length>options.items?options.items:imgs.length;html+="<div class='instagram_gallery'>";for(var i=0;i<max;i++){var url="https://www.instagram.com/p/"+imgs[i].node.shortcode;html+="<a href='"+url+"' target='_blank'>";html+="\t<img src='"+imgs[i].node.thumbnail_src+"' alt='"+options.username+" instagram image "+i+"'"+styles.gallery_image+" />";html+="</a>"}html+=
